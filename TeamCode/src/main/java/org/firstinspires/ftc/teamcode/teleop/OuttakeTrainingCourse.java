...
public class OuttakeTrainingCourse {
    ...
    public OuttakeTrainingCourse(HardwareMap hardwareMap) {
...
//                hardware.outtakeClaw.setPosition(OuttakeConstants.CLAW_CLOSED);
//
//                if (hardware.outtakeSlide1.getCurrentPosition() > OuttakeConstants.SLIDES_CLEAR_WALL) {
...
//                }
//
//                if (actionTimer.getElapsedTimeSeconds() > 0.3 && isSlidesAtSetpoint()) {
//                    isBusy = false;
//                }
                break;
