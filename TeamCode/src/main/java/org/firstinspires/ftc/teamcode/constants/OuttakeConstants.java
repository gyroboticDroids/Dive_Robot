...
public class OuttakeConstants {
    ...
    public static double EXTENSION_SPECIMEN_OFF_WALL = 0.4767;//
    ...
    public static double PIVOT_SAMPLE = 0.527;//
    public static double PIVOT_START = 0.422;//
    public static double PIVOT_RAISE = 0.501;//

    public static double WRIST_TRANSFER = 0.559;//
    public static double WRIST_SPECIMEN = 0.534;//
    public static double WRIST_OFF_WALL = 0.368;//
    public static double WRIST_SAMPLE = 0.398;//
    public static double WRIST_START = 0.548;//
    public static double WRIST_RAISE = 0.463;//
